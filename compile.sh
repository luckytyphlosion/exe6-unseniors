./tools/armips.exe src.asm -sym exe6f-unseniors-temp.sym -strequ ver "exe6f.s" -equ TL_PATCH 0
./tools/armips.exe src.asm -sym exe6g-unseniors-temp.sym -strequ ver "exe6g.s" -equ TL_PATCH 0

./tools/armips.exe src.asm -sym exe6f_us-unseniors-temp.sym -strequ ver "exe6f.s" -equ TL_PATCH 1
./tools/armips.exe src.asm -sym exe6g_us-unseniors-temp.sym -strequ ver "exe6g.s" -equ TL_PATCH 1
